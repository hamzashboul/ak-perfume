    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: isOpen ? '-24px 0 64px rgba(10,10,10,0.5)' : 'none',
        }}
      >
        {/* Header */}
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{
              ...
              color: '#F8F6F2', letterSpacing: '-0.01em',
            }}>السلة</div>
            {totalItems() > 0 && (
              <div style={{
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '1px', padding: '9px 20px',
                  cursor: 'pointer', marginTop: '8px',
                }}
              >تصفح المجموعة</button>
            </div>
          ) : (
              ...
              {items.map((item, i) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '16px 0',
                    borderBottom: i < items.length - 1 ? '0.5px solid rgba(201,169,110,0.08)' : 'none',
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{
                      ...
                      color: '#F8F6F2', marginBottom: '3px',
                      whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
                    }}>{item.name}</div>
                    <div style={{
                      fontFamily: "'DM Sans', sans-serif",
                      fontSize: '0.5625rem', color: 'rgba(248,246,242,0.3)',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0' }}>
                        <button
                          ...
                          style={{
                            ...
                            background: 'rgba(248,246,242,0.06)',
                            border: 'none', borderRadius: '2px 0 0 2px',
                        ...
                        <div style={{
                          ...
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          fontFamily: "'DM Sans', sans-serif",
                          fontSize: '0.75rem', color: '#F8F6F2',
                          borderTop: '0.5px solid rgba(248,246,242,0.08)',
                          borderBottom: '0.5px solid rgba(248,246,242,0.08)',
                        }}>{item.quantity}</div>
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <span style={{
                          ...
                          color: '#C9A96E',
                        }}>{(item.price * item.quantity).toFixed(2)} JD</span>
                        <button
                          onClick={() => removeItem(item.id)}
                          style={{
                            background: 'transparent', border: 'none',
                            color: 'rgba(248,246,242,0.2)', cursor: 'pointer',
        ...
        {items.length > 0 && (
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: '1.5rem', fontWeight: 500, color: '#C9A96E',
              }}>{totalPrice().toFixed(2)} JD</span>
            </div>
            ...
            {/* WhatsApp order */}
            <a
              href={`https://wa.me/962000000000?text=${encodeURIComponent(
                'مرحبا، أريد طلب:\n' +
              ...
              style={{
                ...
                background: 'transparent', color: 'rgba(248,246,242,0.55)',
                fontFamily: "'DM Sans', sans-serif",
                fontSize: '0.625rem', fontWeight: 500, letterSpacing: '0.14em',
                textTransform: 'uppercase', textDecoration: 'none',
                border: '0.5px solid rgba(248,246,242,0.1)',
                borderRadius: '1px',
