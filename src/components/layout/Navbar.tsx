      ...
      >
        <div className="site-container" style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Link href="/" style={{
            ...
            fontSize: '1.25rem', fontWeight: 400, letterSpacing: '0.08em',
            color: 'var(--ivory)', display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0,
          }}>
          ...
          <nav style={{ display: 'flex', gap: '2rem', position: 'absolute', left: '50%', transform: 'translateX(-50%)' }}>
            {navLinks.map(link => (
              <Link key={link.href} href={link.href} style={{
                fontFamily: "'DM Sans', sans-serif", fontSize: '0.625rem', fontWeight: 400,
                letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(248,246,242,0.5)', transition: 'color 200ms',
              }}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <button onClick={() => setLang(l => l === 'ar' ? 'en' : 'ar')} style={{
              ...
              background: 'transparent', border: '0.5px solid rgba(201,169,110,0.25)',
              borderRadius: '1px', padding: '5px 10px', cursor: 'pointer', transition: 'all 200ms',
            }}
            ...
            <button
              ...
              style={{
                ...
                color: 'var(--ivory)', transition: 'color 200ms',
              }}
            ...
            >
              ...
              {cartCount > 0 && (
                <span style={{
                  ...
                  borderRadius: '50%', fontSize: '0.5rem', fontWeight: 700,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                }}>{cartCount}</span>
              )}
            </button>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column' }}>
          {navLinks.map((link, i) => (
            <Link key={link.href} href={link.href} onClick={() => setMenuOpen(false)} style={{
              fontFamily: "'Cormorant Garamond', serif",
              fontSize: 'clamp(2.5rem,8vw,4rem)', fontWeight: 300, letterSpacing: '-0.02em',
              color: 'var(--ivory)', lineHeight: 1.2, padding: '6px 0',
